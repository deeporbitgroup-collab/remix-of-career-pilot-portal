...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    console.log("Sending approval email:", { email: body.clientEmail, approved: body.approved });

    let content: string;
    let subject: string;

    if (body.approved) {
      subject = "Your Career Pilot account has been activated!";
      content = `
        ...
        <h2 style="margin: 0 0 20px 0; color: #166534; font-size: 24px; font-weight: 600; text-align: center;">Account Approved!</h2>
        ...
        <p style="margin: 0 0 20px 0; color: #334155; font-size: 16px; line-height: 1.6;">
          We are pleased to inform you that your access request to Career Pilot has been <strong style="color: #166534;">approved</strong>!
        </p>
        
        <p style="margin: 0 0 30px 0; color: #334155; font-size: 16px; line-height: 1.6;">
          You can now access your personal area and start exploring our career coaching services.
        </p>
        
        <div style="text-align: center; margin: 30px 0;">
          <a href="https://careerpilot.it/client-portal/auth" style="display: inline-block; background: linear-gradient(135deg, #1a365d 0%, #2d4a7c 100%); color: #ffffff; text-decoration: none; padding: 16px 40px; border-radius: 10px; font-size: 16px; font-weight: 600; box-shadow: 0 4px 14px rgba(26, 54, 93, 0.4);">
            Access Your Personal Area
          </a>
        </div>
        
        <div style="background-color: #f0f9ff; border-left: 4px solid #3b82f6; padding: 20px; margin: 30px 0; border-radius: 0 12px 12px 0;">
          <p style="margin: 0; color: #1e40af; font-size: 15px; font-weight: 500;">
            What can you do now?
          </p>
          <ul style="margin: 10px 0 0 0; padding-left: 20px; color: #334155; font-size: 14px; line-height: 2;">
            <li>Explore our career coaching services</li>
            <li>Book consultations with our experts</li>
            <li>Manage your projects and documents</li>
      ...
      subject = "Update on your request - Career Pilot";
      content = `
        <div style="text-align: center; margin-bottom: 30px;">
        ...
        <h2 style="margin: 0 0 20px 0; color: #991b1b; font-size: 24px; font-weight: 600; text-align: center;">Request Not Approved</h2>
        ...
        <p style="margin: 0 0 20px 0; color: #334155; font-size: 16px; line-height: 1.6;">
          We regret to inform you that we are currently unable to approve your access request to Career Pilot.
        </p>
        
        <p style="margin: 0 0 20px 0; color: #334155; font-size: 16px; line-height: 1.6;">
          This may be due to incomplete information or unmet requirements.
        </p>
        
        <div style="background-color: #fef3c7; border-left: 4px solid #f59e0b; padding: 20px; margin: 20px 0; border-radius: 0 12px 12px 0;">
          ...
          <p style="margin: 10px 0 0 0; color: #334155; font-size: 14px; line-height: 1.6;">
            If you believe there has been an error or would like more information, please don't hesitate to contact us at <a href="mailto:careerpilot2025@gmail.com" style="color: #1a365d; font-weight: 600;">careerpilot2025@gmail.com</a>
          </p>
        </div>
