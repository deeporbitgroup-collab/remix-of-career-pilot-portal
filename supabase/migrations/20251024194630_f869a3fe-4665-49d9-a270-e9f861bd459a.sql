-- Add date fields for internship period to student_profiles
ALTER TABLE public.student_profiles
ADD COLUMN IF NOT EXISTS internship_start_date DATE,
ADD COLUMN IF NOT EXISTS internship_end_date DATE;

-- Update the talent_pool_update_student_preferences function to include the new date fields
DROP FUNCTION IF EXISTS public.talent_pool_update_student_preferences(uuid, text[], text[], text, text);
