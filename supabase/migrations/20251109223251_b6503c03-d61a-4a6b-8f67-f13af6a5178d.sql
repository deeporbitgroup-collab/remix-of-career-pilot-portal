-- Fix token generation in request_auth_password_reset by using extensions.gen_random_bytes
-- This resolves: "function gen_random_bytes(integer) does not exist"
